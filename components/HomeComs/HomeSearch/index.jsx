  ...
  return (
    <View>
      ...
      <TouchableOpacity
        ...
        onPress={() => router.push("/screens/destinationsearch")}
      >
        <Text style={styles.inputText}>What's the destination?</Text>
      ...
      {lastDestination && (
        <Pressable style={styles.row} onPress={handleLastDestinationPress}>
          <View style={styles.iconContainer}>
            <AntDesign name={"clock-circle"} size={25} color={"#535353"} />
          </View>
          <Text style={styles.destinationText}>
            {lastDestination.length > 25
              ? `${lastDestination.substring(0, 30)}...`
              : lastDestination}
          </Text>
        </Pressable>
      )}
      ...
      {address && (
        <Pressable style={styles.row} onPress={handleHomePress}>
          <View style={[styles.iconContainer, { backgroundColor: "#04a835" }]}>
            <AntDesign name="home" size={25} color="#535353" />
          </View>
          <Text style={styles.destinationText}>
